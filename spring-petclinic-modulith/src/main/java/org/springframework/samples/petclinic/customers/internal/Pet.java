 ...
 * Internal Pet entity.
 * 
 * This entity is part of the internal implementation and should not be accessed directly
 * by other modules. Other modules should use the CustomerService to access pet information.
 * 
 * @author Ken Krebs
