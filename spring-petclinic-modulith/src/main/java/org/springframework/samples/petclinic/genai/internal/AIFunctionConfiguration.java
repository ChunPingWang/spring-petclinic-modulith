...
import org.springframework.samples.petclinic.genai.internal.AIDataProvider.*;
...
/**
 * Configuration that defines the @Bean functions that the LLM provider will invoke when it
